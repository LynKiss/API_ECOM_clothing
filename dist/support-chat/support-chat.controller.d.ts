...
export declare class SupportChatController {
    ...
    createBotReply(createSupportBotReplyDto: CreateSupportBotReplyDto): Promise<{
        ...
        intent: "greeting" | "shipping" | "returns" | "payment" | "product_search" | "product_recommendation" | "cart_add" | "cart_view" | "checkout" | "identity" | "my_orders" | "order_lookup" | "human_handoff" | "general";
        cartChanged: boolean;
    } | {
        reply: string;
        source: "ai";
        ...
        intent: "greeting" | "shipping" | "returns" | "payment" | "product_search" | "product_recommendation" | "cart_add" | "my_orders" | "order_lookup" | "general";
        cartChanged: boolean;
    }>;
